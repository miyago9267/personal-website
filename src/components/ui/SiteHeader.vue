...
<template>
  <header
    class="sticky top-0 z-10 bg-[var(--header-bg)] backdrop-blur-sm border-b border-[var(--header-border)] min-h-[var(--header-height)] animate-[fade-down_0.5s_var(--ease)]"
  >
    <div class="w-[min(1120px,92vw)] mx-auto py-4 flex items-center gap-4 justify-start">
      ...
      <div class="flex items-center gap-2 ml-auto lg:ml-3">
        <button
          class="w-8 h-8 rounded-full border border-[var(--card-border)] text-[var(--muted)] flex items-center justify-center hover:text-[var(--text)]"
          type="button"
        ...
        <button
          class="w-8 h-8 rounded-full border border-[var(--card-border)] text-[var(--muted)] flex items-center justify-center lg:hidden hover:text-[var(--text)]"
          type="button"
          @click="toggleNav"
        >
          <span
    ...
    >
      <nav
        class="w-[min(280px,80vw)] h-screen bg-[var(--panel-bg)] border-l border-[var(--panel-border)] p-4 grid gap-3 shadow-[-16px_0_30px_rgba(0,0,0,0.2)] animate-[slide-in_0.25s_var(--ease)]"
        @click.stop
      >
        <div class="flex items-center justify-between pb-2 border-b border-[var(--header-border)]">
